...
async function scrapeGoogleSearch(query) {
  ...
  // Step 4: Extract search result data (titles, links, and snippets) from the page without interacting with anything
...
// Example: Search for "The Capital Grille Providence menu"
scrapeGoogleSearch('The Capital Grille Providence menu');
